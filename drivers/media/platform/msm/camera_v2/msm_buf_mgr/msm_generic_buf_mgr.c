...
/*                                                                                                                 */
int msm_buf_mngr_subdev_close(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	unsigned long flags;
	struct msm_get_bufs *bufs, *save;
	struct msm_buf_mngr_device *buf_mngr_dev = v4l2_get_subdevdata(sd);
...
static const struct v4l2_subdev_internal_ops msm_buf_mngr_subdev_internal_ops = {
	.close = &msm_buf_mngr_subdev_close,
};
/*                                                                                                                 */
...
/*                                                                                                                 */
	msm_buf_mngr_dev->subdev.sd.internal_ops = &msm_buf_mngr_subdev_internal_ops;
/*                                                                                                                 */
